...
ecm = 240 # 240 365
treemaker = False # save tree for BDT
treemaker_ww = True # save tree for WW or ZZ final state
...
if treemaker:
    if treemaker_ww:
        ...
        outputDir   = f"/ceph/submit/data/group/fcc/ee/analyses/h_zz_ww/treemaker/ecm{ecm}/stage2/HWW/"
else:
